...
def parse_args():
    ...
    parser.add_argument("--src", help="Source directory containing all Task1_X.txt files.")
    parser.add_argument("--dst", help="Destination directory where the merged files will be stored.")
    return parser.parse_args()


if __name__ == '__main__':
    args = parse_args()
    mergebypoly(args.src, args.dst)
